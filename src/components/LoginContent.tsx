    ...
    <form>
        ...
        {/* <button className="btn btn-primary w-100 py-2" onClick={(e) => hanldleAddEvent(e)} disabled={!isAllWrite} >Agregar</button> */}
                    ...
                    <div className="modal-footer">
                        <button type="button" className="btn btn-danger w-50 m-0" data-bs-dismiss="modal">Close</button>
                        <button type="button" className="btn btn-primary w-50 m-0" data-bs-dismiss="modal" onClick={(e) => hanldleAddEvent(e)} disabled={!isAllWrite} >Send message</button>
                    </div>
    </form>
</main>
